...
First download the package:
    ...
    $ curl https://github.com/savoirfairelinux/cqfd/releases/download/v5.8.0/cqfd-5.8.0-1-any.pkg.tar.zst
...
First download the package:
    ...
    $ curl https://github.com/savoirfairelinux/cqfd/releases/download/v5.8.0/cqfd_5.8.0_all.deb
...
First download the package:
    ...
    $ curl https://github.com/savoirfairelinux/cqfd/releases/download/v5.8.0/cqfd-5.8.0-1.noarch.rpm
